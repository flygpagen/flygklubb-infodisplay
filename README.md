...
- **Display settings**: Ange om skärmen är 4:3 ("tjocktv"), 16:9 ("widescreen") eller stående 9:16. Vid formaten 16:9 och 9:16 läggs en tredje del av skärmen som kan konfigureras att visa väderradar eller flygradar eller något annat. Ange i parametern RADAR_URL vad som ska visas här. Hemma kör vi den lokala FR24-mottagarens radarbild eller snarare tar1090.
